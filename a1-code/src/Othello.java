...
public class Othello {
	...
	public boolean move(int row, int col) {
		...
		if(this.board.move(row, col, this.whoseTurn)) {
			this.whoseTurn = OthelloBoard.otherPlayer(this.whoseTurn);
			if(this.board.hasMove()!=OthelloBoard.BOTH) {
				this.whoseTurn=this.board.hasMove();
			}
			this.numMoves++;
			return true;
		}else {
